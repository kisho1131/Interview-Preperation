...
// characters needed for its anagram is here in it, therefore increase your
// answer To remove the last part (arr[i] part) so that the window can be
// shifted -> If the s[i] is present in map then increase its count and if it
// changes from 0->1 then increase the 'count' variable
...
int main() {
  ...
  // Given a string, and another string, find count of occurances of all
  // anagrams of 2nd one in 1st one.
